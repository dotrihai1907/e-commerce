        ...
        <div className="absolute w-[319.17px] h-[247px] top-[12.9%] left-[11.3%]">
          ...
          <label>
            ...
            <div
              ...
              className="absolute flex justify-end top-[136px] right-[16.2px] font-[700] text-[12px] leading-[14px] text-[#383737] not-italic w-[48px] h-[14px] cursor-pointer"
            >
              Forgot?
            </div>
          </label>
          ...
          <div
            ...
            className="absolute cursor-pointer top-[231px] w-[319.17px] h-[37px] text-center font-[700] text-[14px] leading-[16px] not-italic text-[#646464]"
          >
            Create An Account
          </div>
        </div>
